...
import { handleCreateSustainableAction } from "../controllers/sustainableActionsControllers/sustainableActions.controller.js";

export async function sustainableActionsRoutes(app: FastifyInstance) {
  app.post("/sustainable-actions", handleCreateSustainableAction);
